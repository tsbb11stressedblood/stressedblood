...
def segmentation( img ):
    # image load and conversion to gray
    ...
    # Find countours and fit ellipses to the cells - NEED TO ASSIGN OBJECT:ELLIPSES
    dummy, contours, hierarchy = cv2.findContours(thresh, 1, 2)
    cell_list = []
    ellipse_list = []
    for cnt in contours:
        #cnt = contours[i]
        ...
        cell_list.append(CellClass( ellipse ))
